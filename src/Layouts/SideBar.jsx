...
export const SideBar = () => {
  ...
  return (
    <>
      {isSidebarOpen && (
        <aside className="w-60 min-h-screen p-4 flex flex-col space-y-6 bg-sidebar  text-black   ">
          <div className="px-3 flex items-center  space-x-2">
            ...
            <span className="text-md font-semibold">Arliva</span>
          </div>
          <nav className="flex-1  space-y-2">
            ...
            >
              ...
              <svg
                ...
                height="24"
                viewBox="0 0 12 24"
                className={`${openAbout ? "rotate-90" : "rotate-0"}`}
              >
                <defs>
                  <path
                    id="3"
